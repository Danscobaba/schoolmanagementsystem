...
const Teacher = () => {
    function gotoPend (){
        window.location = '/teacher/pend'
    }
  return (
    <Master>
    <div className='head'><h5><i className="fas fa-user-graduate"></i> Teachers</h5></div>
    <div className="card px-3 py-3">
        ...
        <div className="create">
            <div>
                ...
                <Link to='/teacher/add'><button  className="btn btn-outline-secondary btn-sm"><i className="fas fa-plus-circle text-blue-600"></i> Add teacher</button></Link>
